<?php
   ...
   // $data = '{"userId":"4UM6AgUPuxgZwS3JaPkywSLVrE43"}';
    ...
    if(isset($data)){
       ...
       // echo $dataArray->userId;
        if (isset($dataArray->userId)){
            $strUserId = $dataArray->userId;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '1'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $startingStrongEarned =  $result->num_rows;
        
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '2'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $pushItEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '3'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $stopSmellRosesEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '4'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $nomadEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '5'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $trailFanaticEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '6'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $wheelsOfSteelEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '7'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $burningRubberEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '8'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $longHaulEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '9'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $neighborhoodWatchEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '10'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
            $wayfinderEarned =  $result->num_rows;
            
            $sql = "SELECT intEarnedId FROM medalsEarned WHERE strUserId = '$strUserId' && intMedalId = '11'";
            //executes query
            $result = $conn->query($sql) or die("Query fail");
