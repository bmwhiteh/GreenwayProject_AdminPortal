...
<head>
	...
	<meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport' />
      <!--Color Scheme <link rel="stylesheet" type="text/css" href=<?php //echo $_COOKIE['colorCssLink']; ?>>-->
...
<?php 
    ...
    . "GROUP BY strTicketType ";//add where statement here to show only this ranger's tickets
