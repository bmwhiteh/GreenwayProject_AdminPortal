...
var DateComponent = FC.DateComponent = Component.extend({
	...
	hasAllDayBusinessHours: false, //  unify with largeUnit and isTimeScale?
	...
	_getCalendar: function() { //  strip out. move to generic parent.
		return this.calendar || this.view.calendar;
	},


	_getView: function() { //  strip out. move to generic parent.
		return this.view;
	},
...
Calendar.mixin({
	...
	msToMoment: function(ms, forceAllDay) {
		var mom = FC.moment.utc(ms); //  optimize by using Date.UTC
	...
	*/
	...
	// Event-Specific Date Utilities.  move
	// -----------------------------------------------------------------------------------------------------------------
...
Calendar.mixin({
	...
	getUnitViewSpec: function(unit) {
		...
		if ($.inArray(unit, unitsDesc) != -1) {
			...
			viewTypes = this.header.getViewsWithButtons(); //  include footer as well?
...
Calendar.mixin({
	...
	bindViewHandlers: function(view) {
		...
		view.watch('titleForCalendar', [ 'title' ], function(deps) { //  better system
...
//  make these computable properties in optionsModel
...
var EventPeriod = Class.extend(EmitterMixin, {
	...
	getEventInstances: function() { //  consider iterator
	...
	getEventInstancesWithoutId: function(eventDefId) { //  consider iterator
		var eventInstanceGroupsById = this.eventInstanceGroupsById;
...
var EventDef = FC.EventDef = Class.extend(ParsableModelMixin, {
	...
	className: null, // an array.  rename to className*s* (API breakage)
	miscProps: null,
...
var DayGrid = FC.DayGrid = InteractiveDateComponent.extend(StandardInteractionsMixin, DayTableMixin, {
	...
	view: null, //  make more general and/or remove
	helperRenderer: null,
