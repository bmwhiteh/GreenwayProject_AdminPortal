<?php 
    ...
    */
    ...
    while($row = $resultNotifications->fetch_array(MYSQLI_ASSOC)){ 
    ...
    */
        $notification = array();
        $notification['id'] = $row['intNotificationId'];
        $notification['title'] = "Notification #" . $row['intNotificationId'];
        $notification['start'] = $row['dtSentToUsers'];
        $notification['allDay'] = true;
        $notification['backgroundColor'] = 'purple';
        $notification['textColor'] = 'white';
        $notification['url'] = '../Push_Notifications/notifications.php';
        
        array_push($notificationArray, $notification);
    }

    echo json_encode($notificationArray);
    } catch (PDOException $notification){
