...
/*Users*/
INSERT INTO users (intUserId, strFirstName, strLastName, strUsername, strEncryptedPassword, strEmailAddress, intAge, intWeight,	intHeight, strGender, bitAllowPictures, bitReceiveNotifications, intZipCode, dtStartDate)
VALUES
...
(41,	24,		6,		1,	'9-11-2017',	'9-10-2017',		4,	'The leaves make the path slippery for riding my bike',												'',		'The brush is covering the path'),
...
(49,	9,		8,		0,	'10-6-2017',	'10-4-2017',		5,	'He seems to be living under the bridge',															'',		'There was a squatter near the path'),
