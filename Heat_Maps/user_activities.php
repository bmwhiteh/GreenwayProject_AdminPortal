...
<html>
    ...
    <script src="https://code.jquery.com/jquery-1.11.0.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            $("document").ready(function(){
                ...
                $(".js-ajax-php-json").submit(function(){
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        url: "./filterUserActivity.php", //Relative or absolute path to filterUserActivity.php file
                        data: data,
                        ...
                        success: function(data) {
                           ...
                           console.log(gpsList);
                           //sets the heatmap with the gps points
                           initMap(gpsList);
            ...
            //creates the google map and the heatmap layer
